...
@WebServlet("/consultClient")
public class ConsultClient extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        try {
            ...
            String clientToConsult = request.getParameter("clientToConsult");
            String sql = "SELECT * FROM Cliente WHERE nombre='" + clientToConsult + "';";
