...
public class ConsultProvider extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        try {
            ...
            String providerToConsult = request.getParameter("providerToConsult");
            String sql = "SELECT * FROM Proveedor WHERE nombre='" + providerToConsult + "';";
            ...
            RequestDispatcher disp = getServletContext().getRequestDispatcher("/consultProvider.jsp");
