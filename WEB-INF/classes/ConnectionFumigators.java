...
@WebServlet("/fumigators")
public class ConnectionFumigators extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        try {
            ...
            String sql = "SELECT * FROM Fumigador;";
            ...
            RequestDispatcher disp = getServletContext().getRequestDispatcher("/fumigators.jsp");
